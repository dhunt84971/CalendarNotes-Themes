    ...
    return `
      <div class="cn-app" style="background: var(--appBack); padding: 5px; display: flex; gap: 0; font: 13px/1.5 'Helvetica Neue', Helvetica, Arial, sans-serif; height: 460px; width: 720px; border-radius: 6px; overflow: hidden;">
        ...
        <div style="width: 230px; min-width: 180px; display: flex; flex-direction: column;">
          ...
          <!-- Calendar Header -->
          <div data-theme-group="calendarHeader" style="background: var(--calHeaderBack); color: var(--calHeaderText); height: 34px; display: flex; align-items: center; border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom: 2px solid var(--calHeaderBorder); font-weight: bold; text-transform: uppercase; cursor: pointer;">
            <span style="width: 24px; text-align: center; border-right: 1px solid var(--calHeaderDivider); line-height: 34px;">&#9664;</span>
            <span style="flex: 1; text-align: center; letter-spacing: 1px;">March 2026</span>
            <span style="width: 24px; text-align: center; border-left: 1px solid var(--calHeaderDivider); line-height: 34px; background: var(--calHeaderHoverBack); color: var(--calHeaderHoverText);">&#9654;</span>
            <span style="width: 24px; text-align: center; border-left: 1px solid var(--calHeaderDivider); line-height: 34px;">&#8226;</span>
          </div>

          <!-- Calendar DOW -->
          <div data-theme-group="calendarDOW" style="display: grid; grid-template-columns: repeat(7, 1fr); background: var(--calDOWBack); border: 1px solid var(--calDOWBorder); border-top: none; cursor: pointer;">
            ${['S','M','T','W','T','F','S'].map(d =>
              `<span style="height: 26px; line-height: 26px; text-align: center; font-size: 90%; color: var(--calDOWText);">${d}</span>`
            ).join('')}
          </div>

          <!-- Calendar Days -->
          <div data-theme-group="calendarDays" style="display: grid; grid-template-columns: repeat(7, 1fr); background: var(--calDaysBack); border: 1px solid var(--calDaysBorder); border-top: none; cursor: pointer;">
            ${this._buildCalendarDays()}
          </div>

          <!-- Panel Tabs -->
          <div data-theme-group="tabs" style="display: flex; padding-top: 5px; border-bottom: 2px solid var(--tabBorder); cursor: pointer;">
            ...
            <span style="margin-left: 1px; background: var(--tabBack); color: var(--tabText); padding: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; text-align: center; font-weight: bold; min-width: 50px; font-size: 11px;">DOCS</span>
            <span style="margin-left: 1px; background: var(--tabHoverBack); color: var(--tabHoverText); padding: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; text-align: center; font-weight: bold; min-width: 50px; font-size: 11px;">HOVER</span>
            <span style="margin-left: 1px; background: var(--tabBack); color: var(--tabText); padding: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; text-align: center; font-weight: bold; min-width: 50px; font-size: 11px;">SEARCH</span>
            <span style="flex: 1;"></span>
          </div>
          <div style="background: var(--tabDivider); min-height: 5px;"></div>
          ...
          <div data-theme-group="tasks" style="flex: 1; display: flex; flex-direction: column; overflow: hidden; cursor: pointer;">
            <div style="flex: 1; background: var(--tasksBack); color: var(--tasksText); border: 1px solid var(--tasksBorder); padding: 3px; font-size: 12px; overflow: hidden;">
              ...
              <div style="background: var(--tasksSelectedBack); color: var(--tasksSelectedText);">&#9744; Update colors</div>
            </div>
          </div>
        </div>
        ...
        <div style="flex: 1; display: flex; flex-direction: column; min-width: 0;">
          ...
          <div data-theme-group="notesEditor" style="flex: 1; display: flex; flex-direction: column; background: var(--notesBack); border: 1px solid var(--notesBorder); overflow: hidden; cursor: pointer;">
            <div style="flex: 1; padding: 8px; color: var(--notesText); font-size: 13px;">
              ...
              <div style="margin-top: 8px;"><span style="background: var(--notesSelectedBack); color: var(--notesSelectedText);">selected text</span></div>
            </div>
          </div>
        ...
        <div data-theme-group="pages" style="width: 120px; display: flex; flex-direction: column; background: var(--pagesBack); border: 1px solid var(--pagesBorder); cursor: pointer;">
          <div style="padding: 5px;">
            <span style="background: var(--buttonsBack); color: var(--buttonsText); padding: 3px 8px; border-radius: 5px; font-weight: bold; font-size: 11px; display: block; text-align: center;">+ Page</span>
          </div>
          <div style="flex: 1; overflow: hidden; padding: 0 5px;">
            <div style="background: var(--pageSelectedBack); color: var(--pageSelectedText); padding: 4px 8px; margin: 2px 0; border-radius: 5px; border: 1px solid var(--pageSelectedBorder); font-weight: bold; font-size: 12px;">Page 1</div>
      ...
      <div style="display: flex; gap: 12px; margin-top: 12px; width: 720px;">
        ...
        <div data-theme-group="treeView" style="flex: 1; border: 1px solid var(--docBorder); background: var(--docBack); border-radius: 5px; overflow: hidden; cursor: pointer;">
          <div style="font-size: 11px; font-weight: bold; padding: 4px 8px; background: var(--tvNavBack); color: var(--tvSelectedText);">Documents Tree</div>
        ...
        <div data-theme-group="search" style="flex: 1; border: 1px solid var(--listBorder); background: var(--listBack); border-radius: 5px; overflow: hidden; cursor: pointer;">
          <div style="padding: 5px; display: flex; gap: 5px;">
            ...
            <span style="background: var(--buttonsBack); color: var(--buttonsText); padding: 4px 8px; border-radius: 5px; font-weight: bold; font-size: 11px;">Go</span>
          </div>
        ...
        <div style="flex: 1; display: flex; flex-direction: column; gap: 8px;">
          ...
          <div data-theme-group="application" style="background: var(--docBack); border: 1px solid var(--docBorder); border-radius: 5px; padding: 8px; cursor: pointer;">
            ...
            <div style="font-size: 11px; color: var(--settingsText);">appBack / docBack</div>
          </div>
        </div>
      </div>
